...
namespace MapTileGridCreator.SerializeSystem
{
	public static class SaveLoadFileSystem
	{
		...
		public static Grid3D LoadRawJSON(string path, List<CellInformation> cellInfos, Dictionary<CellInformation, GameObject> pallet, GameObject palletObject)
		{
			string content;
			...
			Grid3D grid = griddto.ToGrid3D(cellInfos, pallet, palletObject);
